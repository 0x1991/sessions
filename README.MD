...
-------|--------------|------------
new | [Session](.#session-object) | `invalid_user_id`
get | [Session](.#session-object) | `token_not_found`
del | [Session](.#session-object) | `token_not_found`
user | [Session](.#session-object)[] | `invalid_user_id`
